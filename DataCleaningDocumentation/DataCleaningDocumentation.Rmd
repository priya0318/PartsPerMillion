...
```{r selectcol, echo=FALSE}
data['Calc_DOY_Since_Prior_No'] <- data$Mean_First_Yes_DOY - data$NumLastNo
data['Calc_DOY_Until_Next_No'] <- data$Mean_Last_Yes_DOY + data$NumFirstNo
```
