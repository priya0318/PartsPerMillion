...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'breaking leaf buds' selecting FirstYes only. 

The mean is 77.71, and we can predict that the number of observations is from the first quarter of the year. i.e., January to March 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'breaking leaf buds' selecting TotDays only. 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'breaking leaf buds' selecting YesDays only. 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'Falling leaves' selecting FirstYes Only. 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'Falling leaves' selecting TotalDays only . 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'Falling leaves' selecting YesDays only. 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'Colored leaves' selecting FirstYes only. 
...
Descrptive statistics with Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance for phenophaseDesc 'Colored leaves' selecting TotalDays only. 
