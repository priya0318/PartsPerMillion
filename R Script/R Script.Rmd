...
Phenophase_ID - PhenoID
Phenophase_Category - PhenoCat
Phenophase_Description - PhenoDesc
...
```{r create AveDays}
for(i in 1:nrow(data)){
data$aveDays[i] <- ceiling((median(data$LastYes[i]:data$FirstNo[i])-median(data$LastNo[i]:data$FirstYes))+1)}
```
...
# Descriptive Statistics (Mean, Median, Min, Max, Range, Sum, Standard mean, variance, Standard deviation, Coefficient variance)
...
# Descriptive Statistics (n, mean, sd, median, min, max, range, skewness, kurtosis, se)
